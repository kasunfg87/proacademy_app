...
import 'package:proacademy_app/screens/sign_up/signup04.dart';
...
class SignUp03 extends StatefulWidget {
  const SignUp03({super.key});

  @override
  State<SignUp03> createState() => _SignUp03State();
}

bool isChecked = false;

class _SignUp03State extends State<SignUp03> {
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: Text(
                                  'Please complete the form below with your contact details to register your student account with Proacademy ',
                              ...
                              InkWell(
                                onTap: () {
                                  value2.getUserCoordinates().whenComplete(
                                      () => value2.pickUserAddress(context));
                                },
                                child: Padding(
                  ...
                  child: Consumer<UserProvider>(
                    builder: (context, value, child) {
                      return CustomButton02(
                        onTap: () {
                          if (value.contactFieldValidate(context)) {
                            NavigationFunction.navigateTo(BuildContext, context,
                                Widget, const SignUp04());
                          }
                        },
                      );
                    },
